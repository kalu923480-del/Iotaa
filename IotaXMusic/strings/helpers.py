...
• /autoapprove on : ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴀᴘᴘʀᴏᴠᴇꜱ ᴊᴏɪɴ ʀᴇǫᴜᴇꜱᴛꜱ.
• /autoapprove off : ᴅɪꜱᴀʙʟᴇꜱ ᴀᴜᴛᴏ ᴀᴘᴘʀᴏᴠᴀʟ.

<b><u>ᴠᴄ ʟᴏɢɢᴇʀ :</u></b>

• /vclogger on : ᴇɴᴀʙʟᴇꜱ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ʟᴏɢɢɪɴɢ.
• /vclogger off : ᴅɪꜱᴀʙʟᴇꜱ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ʟᴏɢɢɪɴɢ.
"""

# ───────────────────────────────────────────────────────────────────────
HELP_31 = """
<b><u>ǫᴜᴇᴜᴇ &amp; ᴘʟᴀʏ ᴛᴏᴏʟs :</u></b>

• /np | /nowplaying : sʜᴏᴡ ᴄᴜʀʀᴇɴᴛ ᴛʀᴀᴄᴋ
• /clearqueue | /cq : ᴄʟᴇᴀʀ ǫᴜᴇᴜᴇ (ᴋᴇᴇᴘs ᴄᴜʀʀᴇɴᴛ)
• /remove &lt;n&gt; : ʀᴇᴍᴏᴠᴇ ǫᴜᴇᴜᴇ ᴘᴏsɪᴛɪᴏɴ n
• /playnext &lt;n&gt; : ᴍᴏᴠᴇ ᴛʀᴀᴄᴋ n ᴛᴏ ᴘʟᴀʏ ɴᴇxᴛ
• /replay : ʀᴇsᴛᴀʀᴛ ᴄᴜʀʀᴇɴᴛ sᴏɴɢ
• /lyrics [artist - song] : ғᴇᴛᴄʜ ʟʏʀɪᴄs
• /fav : sᴀᴠᴇ ᴄᴜʀʀᴇɴᴛ / ɴᴀᴍᴇ ᴛᴏ ғᴀᴠᴏʀɪᴛᴇs
• /favorites : ʟɪsᴛ ʏᴏᴜʀ ғᴀᴠᴏʀɪᴛᴇs
• /unfav &lt;n&gt; : ʀᴇᴍᴏᴠᴇ ғᴀᴠᴏʀɪᴛᴇ
• /history : ᴄʜᴀᴛ ᴘʟᴀʏ ʜɪsᴛᴏʀʏ
• /radio &lt;n&gt; : ᴘʟᴀʏ ʀᴀᴅɪᴏ sᴛᴀᴛɪᴏɴ
• /afk [reason] : sᴇᴛ ᴀғᴋ
• /nightmode on|off|set : ɴɪɢʜᴛ ᴍᴏᴅᴇ
• /autoapprove on|off : ᴀᴜᴛᴏ ᴊᴏɪɴ ᴀᴘᴘʀᴏᴠᴇ
• /vclogger on|off : ᴠᴄ ᴇᴠᴇɴᴛ ʟᴏɢs
• /song : ᴅᴏᴡɴʟᴏᴀᴅ sᴏɴɢ (ᴘʀɪᴠᴀᴛᴇ)
"""
